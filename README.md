...
This unit covers the basic foundation of Android application development.  
It includes simple beginner-level practicals to understand Android Studio setup, activity lifecycle, UI basics, and user interaction.
...
# Unit 2 - Android UI Components and Navigation

This unit focuses on user interface controls, navigation, and basic interaction between activities and fragments.  
It helps in understanding how Android applications handle input, display lists, and move between screens.
...
# Unit 3 - Layouts, Services, Animation, and System Features

This unit includes practicals related to layouts, background processing, Android services, animation, menus, and communication features.
...
# Unit 4 - Storage, Dialogs, Media, and Data Handling

This unit focuses on Android data storage techniques, user dialogs, media playback, and content providers.
...
# Unit 5 - Data Exchange and Parsing

This unit focuses on document/data handling and JSON parsing, which are useful for modern Android applications that work with APIs and structured data.
